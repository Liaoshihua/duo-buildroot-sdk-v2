...
elseif("${CONFIG_CROSS_COMPILE_SDK}" STREQUAL "riscv64-unknown-linux-musl-")
  if (DEFINED ENV{RISCV_LEGACY})
    set( CMAKE_C_FLAGS "${CMAKE_C_FLAGS} -mtune=thead-c906" )
    ...
    set( CMAKE_C_FLAGS "${CMAKE_C_FLAGS} -mtune=thead-c906" )
    set( CMAKE_C_FLAGS "${CMAKE_C_FLAGS} -march=rv64gcv_zfh -mcmodel=medany -mabi=lp64d" )
    set( CMAKE_CXX_FLAGS "${CMAKE_CXX_FLAGS} -mtune=thead-c906" )
    set( CMAKE_CXX_FLAGS "${CMAKE_CXX_FLAGS} -march=rv64gcv_zfh -mcmodel=medany -mabi=lp64d" )
  endif()
